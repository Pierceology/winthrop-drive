...
function bind(){
 ...
 $('eveningDrive').onclick=()=>{evening.active=!evening.active;const night=evening.active;$('eveningDrive').setAttribute('aria-pressed',String(night));$('eveningDrive').textContent=night?'Return to daylight':'Evening drive';neighborhoodLight.value=night?1:0;hemi.intensity=night?.3:2;sun.intensity=night?.15:1.6;scene.background.set(night?'#142237':'#a2bdc9');scene.fog.color.copy(scene.background);};
